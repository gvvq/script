...
async def meteo(ctx, location: str, days: int = 1):
    ...
    try:
        ...
        for day in range(days):
            ...
            date, condition, max_temp, min_temp, humidity = forecast_day['date'], forecast_day['day']['condition']['text'], forecast_day['day']['maxtemp_c'], forecast_day['day']['mintemp_c'], forecast_day['day']['avghumidity']
